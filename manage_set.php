...
if (!!$_rows = _fetch_array("SELECT 
	...
	if ($_html['post'] == 30) {
		...
		$_html['post_html'] = '<input type="radio" name="post" value="30" /> 30秒 <input type="radio" name="post" value="60" /> 1分钟 <input type="radio" name="post" value="180" checked="checked" /> 6个月';
	}
...
?>
	<div id="member_main">
		...
		<dl>
    		...
    		<dd>·好友每页列表数：<?php echo $_html['blog_html'];?></dd>
