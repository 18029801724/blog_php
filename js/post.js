window.onload = function () {
	...
	qa[0].onclick = function() {
		window.open('q.php?num=36&path=qpic/1/','q','width=600,height=400,scrollbars=1');
	};
	qa[1].onclick = function() {
		window.open('q.php?num=20&path=qpic/2/','q','width=600,height=400,scrollbars=1');
	};
	qa[2].onclick = function() {
		window.open('q.php?num=20&path=qpic/3/','q','width=600,height=400,scrollbars=1');
	};
